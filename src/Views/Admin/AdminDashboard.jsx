      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-6 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <button className="bg-amber-500 text-white font-bold py-4 px-6 rounded-lg flex items-center justify-center shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">
